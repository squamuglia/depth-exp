  ...
  _createClass(FlickityComponent, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (this.props.reloadOnUpdate || !prevState.flickityReady && this.state.flickityReady) {
        ...
        this.flkty.options.draggable = this.props.options.draggable === undefined ? this.props.children ? this.props.children.length > 1 : false : this.props.options.draggable;
